...
//輸入WIFI連線帳號密碼
const char* ssid     = "davidphone";   //your network SSID
const char* password = "londoner";   //your network password

//String myToken = "5801867724:AAHNSBa-_-yaWerFrDNOdCF11sFbf9abhRw";   // Create your bot and get the token -> https://telegram.me/fatherbot
//String myChatId = "963272576";   // Get chat_id -> https://telegram.me/userinfobot

String myToken = "6119736034:AAHUJq5zRAOvubPe8m-PYkX9p7MPVAu20Nw";   
String myChatId = "1652171331";
...
void setup() 
{
  ...
  sendMessage2Telegram(myToken, myChatId, "Hello Master.\nHow are you?");
